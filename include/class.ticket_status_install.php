<?php
/*********************************************************************
    class.ticket_status_install.php

    Ticket status extension Intaller - installs the latest version.
...
class TicketStatusInstaller extends SetupWizard {
    ...
    function install($vars) {
        ...
        $sql='SELECT ticket_status.* FROM '.TICKET_STATUS_TABLE;
        ...
        $schemaFile =INCLUDE_DIR.'upgrader/ticket_status/sql/install_ticket_status.sql'; //DB dump.
