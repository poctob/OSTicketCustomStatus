...
**********************************************************************/
if(!defined('OSTSCPINC') || !$thisstaff || !$thisstaff->canManageTicketStatus()) die('Access Denied');
$info=array();
$qstr='';
...
?>
<form action="ticket_status.php?<?php echo $qstr; ?>" method="post" id="save">
 <?php csrf_token(); ?>
    ...
    <tbody>
        ...
        <tr>
            <td colspan=2>
                ...
                <br>
                <div style="padding-top:3px;"><b>Default Status</b>:&nbsp;<span class="faded">This is the default status</span></div>            
                  <input type="checkbox" name="default" value="1" <?php echo $info['default']?'checked="checked"':''; ?>>                 
                 <br>
                 <div style="padding-top:3px;"><b>Closed Ticket Status</b>:&nbsp;<span class="faded">This is the default status</span></div>            
                  <input type="checkbox" name="closed" value="1" <?php echo $info['closed']?'checked="checked"':''; ?>>                 
                 <br>
...
<p style="padding-left:225px;">
    ...
    <input type="button" name="cancel" value="Cancel" onclick='window.location.href="ticket_status.php"'>
</p>
</form>
