        ...
        <tr><td>Can View Staff Stats.</td>
         ...
         <tr><td>Can <b>Manage</b> Equipment</td>
            <td>
                ...
                &nbsp;&nbsp;<i>Ability to manage equipment</i>
            </td>
        </tr>
          <tr><td>Can <b>Manage</b> Ticket Status</td>
            <td>
                <input type="radio" name="can_manage_ticket_status"  value="1"   <?php echo $info['can_manage_ticket_status']?'checked="checked"':''; ?> />Yes
                &nbsp;&nbsp;
                <input type="radio" name="can_manage_ticket_status"  value="0"   <?php echo !$info['can_manage_ticket_status']?'checked="checked"':''; ?> />No
                &nbsp;&nbsp;<i>Ability to manage ticket status</i>
            </td>
        </tr>
        <tr>
            <th colspan="2">
