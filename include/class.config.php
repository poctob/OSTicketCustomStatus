...
class OsticketConfig extends Config {
    ...
    function isTicketStatusEnabled() {
        require_once(INCLUDE_DIR.'class.ticket_status.php');
        return ($this->get('enable_ticket_status'));
    }
        ...
        switch(strtolower($vars['t'])) {
           ...
           case 'autoresp':
            ...
            case 'equipment':
                ...
                break;
            case 'ticket_status':
                return $this->updateTicketStatusSettings($vars, $errors);
                break;
            default:
	...
	return $this->updateAll(array(
     ...
     function updateTicketStatusSettings($vars, &$errors) {

        if($errors) return false;

	return $this->updateAll(array(
            'enable_ticket_status'=>isset($vars['enable_ticket_status'])?1:0,
           ));  
    }
